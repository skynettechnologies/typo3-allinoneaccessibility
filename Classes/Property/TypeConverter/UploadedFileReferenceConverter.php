...
class UploadedFileReferenceConverter extends AbstractTypeConverter
{
    ...
    protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration)
    {
        ...
        $allowedFileExtensions = $configuration->getConfigurationValue('Skynettechnologies\\Allinoneaccessibility\\ Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
        ...
        $uploadFolderId = $configuration->getConfigurationValue('Skynettechnologies\\Allinoneaccessibility\\ Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
        ...
        $conflictMode = $configuration->getConfigurationValue('Skynettechnologies\\Allinoneaccessibility\\ Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $defaultConflictMode;
     ...
     * @return \Skynettechnologies\Allinoneaccessibility\Domain\Model\FileReference
     */
    ...
    protected function createFileReferenceFromFalFileReferenceObject(FalFileReference $falFileReference, $resourcePointer = null)
    {
        if ($resourcePointer === null) {
            /** @var $fileReference \Skynettechnologies\Allinoneaccessibility\Domain\Model\FileReference */
